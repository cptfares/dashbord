...
import lightLoan from "../../images/lightLoan.svg";
import loanDark from "../../images/loanDark.svg";
  ...
  render() {
    return (
        ...
        <nav className={s.root}>
          ...
          <h5 className={s.navTitle}>SERVICES</h5>
          <ul className={s.nav}>
            <LinksGroup
              onActiveSidebarItemChange={activeItem =>
                this.props.dispatch(changeActiveSidebarItem(activeItem))
              ...
              index="main"
            >
              {window.location.href.includes("GetLoan") ? (
                <img
                  src={loanDark}
                  alt="lightLoan"
                  width={"24px"}
